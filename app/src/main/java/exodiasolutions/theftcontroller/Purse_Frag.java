...
public class Purse_Frag extends Fragment {
    ...
    exodiasolutions.buzz.Custom.CEditText seller,company,material,price,article,color,other1,other2;
    Button submit;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_purse_, container, false);
...
// Always show the chooser (if there are multiple options available)
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(seller.getText().toString().length()>0&&company.getText().toString().length()>0&&article.getText().toString().length()>0&&material.getText().toString().length()>0&&
                        color.getText().toString().length()>0&&price.getText().toString().length()>0){
                    progressDialog.setMessage("Please Wait");
                    progressDialog.show();
                    final MyHttpClient myHttpClient = new MyHttpClient(getActivity(),"https://vintagevow-sunnynarang.legacy.cs50.io/theft/buy_purse.php",new String[]
                            {
