...
import exodiasolutions.theftcontroller.R;

import static android.app.Activity.RESULT_OK;

public class Bangle_Frag extends Fragment {
    ...
    exodiasolutions.buzz.Custom.CEditText seller,company,weight,material,stone,diameter,karat,price,other1,other2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_bangle_, container, false);
        ...
        diameter = v.findViewById(R.id.diameter);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(seller.getText().toString().length()>0&&company.getText().toString().length()>0&&weight.getText().toString().length()>0&&material.getText().toString().length()>0&&
                        stone.getText().toString().length()>0&&diameter.getText().toString().length()>0&&karat.getText().toString().length()>0&&price.getText().toString().length()>0){

                    progressDialog.setMessage("Please Wait");
                    progressDialog.show();
                    final MyHttpClient myHttpClient = new MyHttpClient(getActivity(),"https://vintagevow-sunnynarang.legacy.cs50.io/theft/buy_bangle.php",new String[]
                            {"seller",seller.getText().toString(),
                                    "company",company.getText().toString(),
                                    "weight",weight.getText().toString(),
                                    "material",material.getText().toString(),
                                    "stone",stone.getText().toString(),
                                    "size",diameter.getText().toString(),
