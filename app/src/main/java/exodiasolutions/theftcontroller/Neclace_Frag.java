...
public class Neclace_Frag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_neclace_, container, false);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(seller.getText().toString().length()>0&&company.getText().toString().length()>0&&weight.getText().toString().length()>0&&material.getText().toString().length()>0&&
                    ...
                    progressDialog.show();
                    final MyHttpClient myHttpClient = new MyHttpClient(getActivity(),"https://vintagevow-sunnynarang.legacy.cs50.io/theft/buy_necklace.php",new String[]
