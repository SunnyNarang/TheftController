...
public class Ring_Frag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_ring_, container, false);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                stone.getText().toString().length()>0&&diameter.getText().toString().length()>0&&karat.getText().toString().length()>0&&price.getText().toString().length()>0){
                    ...
                    progressDialog.show();
                    final MyHttpClient myHttpClient = new MyHttpClient(getActivity(),"https://vintagevow-sunnynarang.legacy.cs50.io/theft/buy_ring.php",new String[]
                            {"seller",seller.getText().toString(),
                                    ...
                                    "diameter",diameter.getText().toString(),
