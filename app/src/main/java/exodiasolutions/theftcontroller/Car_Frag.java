...
public class Car_Frag extends Fragment {
    ...
    exodiasolutions.buzz.Custom.CEditText seller,company,model,color,year,varient,distance,price,number,other1,other2;
    Button submit;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_car_, container, false);
        ...
        varient = v.findViewById(R.id.varient);
...
// Always show the chooser (if there are multiple options available)
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(seller.getText().toString().length()>0&&company.getText().toString().length()>0&&model.getText().toString().length()>0&&color.getText().toString().length()>0&&
                        year.getText().toString().length()>0&&varient.getText().toString().length()>0&&distance.getText().toString().length()>0&&price.getText().toString().length()>0
                        &&number.getText().toString().length()>0){

                    progressDialog.setMessage("Please Wait");
                    progressDialog.show();
                    final MyHttpClient myHttpClient = new MyHttpClient(getActivity(),"https://vintagevow-sunnynarang.legacy.cs50.io/theft/buy_car.php",new String[]
                            {"seller",seller.getText().toString(),
                                    ...
                                    "varient",varient.getText().toString(),
