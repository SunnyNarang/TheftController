...
$stmt = $conn->prepare("INSERT INTO `theft`.`earring_buy` (`image`,`other1`,`other2`,`id`, `seller`, `company`, 
`weight`, `material`, `size`, `karat`, `price`,`buyer`) VALUES (?,?, ?,NULL, ?,?,?,?,?,?,?,?);");
...
$stmt2 = $conn->prepare("SELECT * FROM earring");
...
$result = $stmt2->get_result();
 ...
 $stmt4=$conn->prepare("INSERT INTO `earring_sus` (`buy_id`,`stolen_id`,`seller_id`) VALUES(?,?,?)"); 
