...
<form action="bangle.php" method="post" enctype="multipart/form-data">
...
$stmtq = $conn->prepare('INSERT INTO `bangle` (`compname`, `material`, `weight`, `size`, `karat`, `stone`, `price`, `image`,`other1`,`other2`)  values(?,?,?,?,?,?,?,?,?,?)');
