...
<form action="chain.php" method="post" enctype="multipart/form-data">
<ul class="form-style-1">
	...
	<li>
        ...
        <input type="text" name="field4" class="field-long" placeholder='18",20",etc.'/>
    </li>
	<li>
...
$stmtq = $conn->prepare('INSERT INTO `chain` (`compname`, `material`, `weight`, `size`, `karat`, `price`, `image`,`other1`,`other2`)  values(?,?,?,?,?,?,?,?,?)');
			$stmtq->bind_param("sssssssss", $field1,$field2,$field3,$field4,$field5,$field7,$final_name,$field8,$field9);
			if($stmtq->execute()){
