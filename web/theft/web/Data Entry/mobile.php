...
<ul class="form-style-1">
    <li>
		...
		<input type="text" name="field1" class="field-long" placeholder="Samsung,Apple,etc." required/> </li>
    <li>
        <label><span>Model</span></label>
        <input type="text" name="field2" class="field-long" placeholder="S8,6s,etc."/>
    </li>
    <li>
        <label><span>IMEI No.</span></label>
        <input type="text" name="field3" class="field-long" placeholder="1546458454.."/>
    </li>
	<li>
	...
	<!--<li>
        <label><span>Linked Email Id</span></label>
        <input type="text" name="field5" class="field-long" placeholder="user@gmail.com"/>
    </li>-->
	<li>
...
$stmtq = $conn->prepare('INSERT INTO `phone` (`brand`, `model`, `number`, `location`, `email`, `color`, `price`, `image`,`other1`,`other2`)  values(?,?,?,?,?,?,?,?,?,?)');
