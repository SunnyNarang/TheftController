...
<form action="ring.php" method="post" enctype="multipart/form-data">
<ul class="form-style-1">
	...
	<li>
        <label><span>Diameter</span></label>
...
$stmtq = $conn->prepare('INSERT INTO `ring` (`compname`, `material`, `weight`, `size`, `karat`, `stone`, `price`, `image`,`other1`,`other2`)  values(?,?,?,?,?,?,?,?,?,?)');
